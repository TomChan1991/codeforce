...
def build(l, r):
    # print(l, r)
    if l == r:
        return node(l, l, 1, 1, int(inpy[2][l]) + 1, 0, None, None)
    mid = (l + r) // 2
    ...
    x, y = int(inpy[2][mid]), int(inpy[2][mid + 1])
    if x == 1:
        v += nl.p * nr.pp * (19 - (x * 10 + y))
        p += nl.p * nr.ppp * (19 - (x * 10 + y))
        pp += nl.ppp * nr.pp * (19 - (x * 10 + y))
        ppp += nl.ppp * nr.ppp * (19 - (x * 10 + y))
    v %= 998244353 
    p %= 998244353
    pp %= 998244353
    ppp %= 998244353
...
def update(index, v, root):
    ...
    x, y = int(inpy[2][mid]), int(inpy[2][mid + 1])
    if x == 1:
        root.v += nl.p * nr.pp * (19 - (x * 10 + y))
        root.p += nl.p * nr.ppp * (19 - (x * 10 + y))
        root.pp += nl.ppp * nr.pp * (19 - (x * 10 + y))
        root.ppp += nl.ppp * nr.ppp * (19 - (x * 10 + y))
    root.p %= 998244353
    root.pp %= 998244353
    root.ppp %= 998244353
    return
